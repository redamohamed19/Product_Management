  ...
  return (
    <div className=" w-4/6">
        ...
        <div className='flex justify-between py-4 items-center'>
            <button className='border-[1px] border-[#FF5C60] px-3 py-2 text-[#FF5C60] leading-5 text-base font-bold rounded-lg'>Log out</button>
            <div className='flex py-4 gap-4'>
            <button className='border-[1px] border-[#83859C] px-3 py-2 text-[#83859C] leading-5 text-base font-bold rounded-lg'>Discard changes</button>
            <button className='bg-[#4E60FF] px-3 py-2 text-white leading-5 text-base font-bold rounded-lg'>Save changes</button>
            </div>
        </div>
        </form>
