...
<ul className='flex gap-6  px-8  col-start-4 col-end-7 2xl:col-end-8 justify-self-end lg:col-start-2 lg:col-end-7 sm:hidden'>
    ...
    <div className='col-start-7 justify-self-end lg:col-start-7  2xl:col-start-8 sm:hidden'> <button className='bg-[#4E60FF] text-white rounded-xl px-4 py-2 font-semibold outline-none'>Sign In</button> </div>
